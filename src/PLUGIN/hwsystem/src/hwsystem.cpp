...
namespace hwsystem
{
    ...
    CallbackReturn Hwsystem::on_configure([[maybe_unused]] const rclcpp_lifecycle::State &previous_state)
    {
        try
        {
            ...
            action_group_sub_ = node_->create_subscription<group_action::msg::GroupAction>(action_group_topic_, rclcpp::QoS(10), std::bind(&Hwsystem::action_group_callback, this, std::placeholders::_1));
    ...
    void Hwsystem::action_group_callback(const group_action::msg::GroupAction::SharedPtr msg)
    {
        ...
        if (msg->group_id == 0 || msg->repetitions == 0)
        {
